...
$query = 'SELECT chat.* , a.usuario AS usuario1, b.usuario AS usuario2 FROM chat INNER JOIN usuario AS a ON a.idusuario = chat.idusuario1 INNER JOIN usuario AS b ON b.idusuario = chat.idusuario2 WHERE idusuario1 =\''.$chat['usuario1'] .'\' AND idusuario2 =\''.$chat['usuario2'].'\';';
$objetos = array();
//esta asignando
