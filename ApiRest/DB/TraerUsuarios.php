...
$query = 'SELECT usuario.*, usuariopaciente.idpaciente AS idpaciente, claves.clave AS clave FROM(( usuario INNER JOIN usuariopaciente ON usuario.idusuario = usuariopaciente.idusuario) INNER JOIN claves ON usuario.idclave = claves.idclaves);';
$objetos = array();
//esta asignando
